...
namespace Repository.Migrations
{
    ...
    [Migration("20260905135520_SpajanjeStolovaURezervaciji")]
    partial class SpajanjeStolovaURezervaciji
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entiteti.AdminAkcija", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CiljniKorisnikId")
                    ...
                    b.HasIndex("CiljniKorisnikId");

                    b.HasIndex("Datum");

                    b.HasIndex("TipAkcije");

                    b.ToTable("AdminAkcije");
                });
            ...
            modelBuilder.Entity("Domain.Entiteti.GalerijaSlika", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Aktivan", "Grupa", "Redosled");

                    b.ToTable("GalerijaSlike");
                });
            ...
            modelBuilder.Entity("Domain.Entiteti.PostavkeRestorana", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("GeoDuzina")
                        .HasColumnType("decimal(9,6)");

                    b.Property<decimal?>("GeoSirina")
                        .HasColumnType("decimal(9,6)");
                    ...
                    b.Property<string>("OpisRestorana")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.ToTable("PostavkeRestorana", t =>
                        {
                            t.HasCheckConstraint("CK_PostavkeRestorana_JedanRed", "[Id] = 1");
                        });
                });

            modelBuilder.Entity("Domain.Entiteti.PrijavaProblema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("DatumResavanja")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("PrijavioZaposleniId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ResioZaposleniId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PrijavioZaposleniId");

                    b.HasIndex("ResioZaposleniId");

                    b.HasIndex("Status", "DatumPrijave");

                    b.ToTable("PrijaveProblema");
                });
            ...
            modelBuilder.Entity("Domain.Entiteti.Rezervacija", b =>
                {
                    ...
                    b.HasIndex("KodRezervacije", "StoId")
                        .IsUnique();

                    b.ToTable("Rezervacije");
                });

            modelBuilder.Entity("Domain.Entiteti.SlikaStavkeMenija", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StavkaMenijaId", "Redosled");

                    b.ToTable("SlikeStavkiMenija");
                });
            ...
            modelBuilder.Entity("Domain.Entiteti.Zaposleni", b =>
                {
                    ...
                    b.Property<bool>("PrikaziNaSajtu")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("PrikaziNaSajtu", "Redosled");
            ...
            modelBuilder.Entity("Domain.Entiteti.AdminAkcija", b =>
                {
                    b.HasOne("Domain.Entiteti.Zaposleni", "Administrator")
                        .WithMany()
                        .HasForeignKey("AdministratorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entiteti.Korisnik", "CiljniKorisnik")
                        .WithMany()
                        .HasForeignKey("CiljniKorisnikId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Administrator");

                    b.Navigation("CiljniKorisnik");
                });
            ...
            modelBuilder.Entity("Domain.Entiteti.PrijavaProblema", b =>
                {
                    b.HasOne("Domain.Entiteti.Zaposleni", "PrijavioZaposleni")
                        .WithMany()
                        .HasForeignKey("PrijavioZaposleniId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entiteti.Zaposleni", "ResioZaposleni")
                        .WithMany()
                        .HasForeignKey("ResioZaposleniId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("PrijavioZaposleni");

                    b.Navigation("ResioZaposleni");
                });
