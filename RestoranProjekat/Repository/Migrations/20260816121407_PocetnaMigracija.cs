        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZabranaKomentarisanjaDo = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RefreshToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RefreshTokenIstice = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NazivSlucajaKoriscenja = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Datum = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UspesnoIzvrseno = table.Column<bool>(type: "bit", nullable: false),
                    Poruka = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditLogovi", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogovi_Datum",
                table: "AuditLogovi",
                column: "Datum");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogovi_KorisnikId",
                table: "AuditLogovi",
                column: "KorisnikId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogovi_NazivSlucajaKoriscenja",
                table: "AuditLogovi",
                column: "NazivSlucajaKoriscenja");
